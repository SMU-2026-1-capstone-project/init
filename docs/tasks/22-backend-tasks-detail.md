...
> ## ⚠️ 이 문서를 «남은 일» 근거로 쓰지 말 것 (2026-08-08)
>
> [`27-implementation-gaps.md`](./27-implementation-gaps.md) 가 이미 명시적으로 경고해뒀다:
>
> > *"`22-backend-tasks-detail.md` 는 방대하지만 일부 항목이 실제 구현 상태를 못 따라가고 있어(예: 세션 피드백 조회 API는 실제로는 구현돼 있는데 그 문서엔 미구현으로 표시) **전체 신뢰는 어려움**"*
>
> | 목적 | 지금 볼 문서 |
> |---|---|
> | **백엔드에 무엇이 남았나** | [`28-remaining-work-plan.md`](./28-remaining-work-plan.md) ← **정본** |
> | AI 트랙에 무엇이 남았나 | [`30-ai-remaining-work.md`](./30-ai-remaining-work.md) |
> | 코드로 확인된 갭만 | [`27-implementation-gaps.md`](./27-implementation-gaps.md) |
>
> **그럼 이 문서는 왜 남기나** — *"어떤 파일을 / 무엇을 / 왜 / 어디까지"* 를 항목별로 풀어놓은 **작업 지시 수준의 상세**가 다른 문서엔 없다. 항목을 **골랐다면** 여기서 착수 재료를 얻고, **무엇이 남았는지 세는 데는 쓰지 않는다.**
>
> 🔴 상속 관계도 낡았다 — 출처인 `21-task-assignment.md` 는 2026-08-07 에 코드 대조로 갱신됐고, 그 출처인 `20-feature-roadmap.md` 는 2026-05-23 에서 멈춰 프론트 칸이 뒤집혔다.

마지막 업데이트: 2026-05-24 (부분 수정 2026-07-16) · 신뢰도 경고 추가: **2026-08-08**
