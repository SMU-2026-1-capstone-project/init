...
>
> 🔴 **2026-08-09 재정정 — 그 특정도 조건부였다** ([`../../loadtest/results/commit-count-2026-08-09/`](../../loadtest/results/commit-count-2026-08-09/), [#166](https://github.com/Shadowfit/init/issues/166)). 위 측정은 **모든 부하가 한 세션으로 가는** 페이로드였다. 다세션으로 바꾸면 내구성 완화 효과가 **1.03배**로 사라지고 처리량은 220 → 649 RPS 다. **즉 «폭주가 아플 자리» 는 fsync 가 아니다** — 다세션·기본 내구성에서 아픈 자리는 **커넥션 풀**로 나타났다(`pool=5` 가 plateau 의 **69%**). 이 행이 지적한 «풀 한도» 갭이 오히려 되살아난다.
>
