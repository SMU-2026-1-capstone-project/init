...
>
> ✅ **2026-08-12 — 이 항목을 [`../../loadtest/AWS-RIDE-ALONG.md`](../../loadtest/AWS-RIDE-ALONG.md) §1 從-R1 로 옮겨 적었다.** 여기 적어두는 것만으로는 또 놓친다는 것이 위 사고의 교훈이라, **인프라를 띄우는 사람이 여는 파일**에 목록을 모았다. 이 문단은 사고 기록으로 남기고, 실행 여부는 그 파일의 §5(삭제 전 체크리스트)가 지킨다.
