...
- ~~동시 활성 세션 수가 단일 인스턴스 한도(메모리/CPU) 안에 들어오는가?~~ → ✅ **답 나옴 (2026-08-26)**. [`ai-load-budget.md §7`](./ai-load-budget.md) — 물리 8코어 단독 156세션·동거 89~105세션. 이 문서 작성 당시 걱정하던 규모(N=5)를 20배 넘게 초과 달성해서, **동시성은 D2 격상 사유가 아니다**
