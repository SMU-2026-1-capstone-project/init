...
| **P3** | **백업/복구 RTO·RPO** | 「몇 분인가」는 디스크 성능이 지배한다. 단 「PITR 이 되는가」는 이진 사실이라 **로컬에서 먼저** 확인하고 올린다 | 🟡 설계 완료 · rig 없음 — [`../docs/decisions/backup-restore-rto-rpo.md`](../docs/decisions/backup-restore-rto-rpo.md) | 셋업 2~3h + 측정 2h |
