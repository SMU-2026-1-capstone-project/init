...
상태: **5회 탑승 완료 (P1 2026-08-12 · P3 2026-08-13 · P3-b 2026-08-13~14 · P6 2026-08-16 · P6 2라운드 2026-08-17) + 팔 B 교정 1판 (2026-08-14)**
      — 남은 主 는 **P2·P4·P5**. 그중 **rig 까지 다 돼 있고 한 판도 안 돌린 것은 P5·P4 둘**이다
      (P4 rig 은 2026-08-22 에 섰다 — [REPL2-RIG.md](results/replication-2026-08-17/REPL2-RIG.md)).
...
| **P4** | **복제 지연 · 반동기 대가** | 인스턴스 2대가 전제. ⭐ **반동기 대가는 AZ 간 RTT 에 지배**되므로 로컬에선 구조적으로 과소평가된다 | 🟢 **설계·rig 완료 (설계 2026-08-13 · rig 2026-08-22)** — [설계](../docs/decisions/replication-lag-and-semisync.md) · [rig](results/replication-2026-08-17/REPL2-RIG.md) · 러너 단계 `repl_preflight`·`repl_gate`·`repl`([2대 절차](aws/README.md)). 🔴 **한 판도 안 돌았고 2대 절차를 실제로 밟아본 적이 없다.** 착수는 여전히 미결정(§7) | 게이트 2~3h + 측정 2~3h **(예상)** — rig 배선 기준(1,000만 행·SQL writer·판당 180s)이면 **합쳐 1.5~2h** 로 본다 |
